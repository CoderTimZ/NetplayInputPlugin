...
public:
        ...
        socket_(io_service, context)
    {
        ...
        resolver_.async_resolve(query,
            bind(&client::handle_resolve, this,
...
private:
    ...
    void handle_handshake(const system::error_code& error)
    {
        if (!error)
        {
            ...
            asio::async_write(socket_, request_,
                bind(&client::handle_write_request, this,
                    asio::placeholders::error));
        } else
        {
    ...
    void handle_write_request(const system::error_code& err)
    {
        if (!err)
        {
            ...
            asio::async_read_until(socket_, response_, "\r\n",
                bind(&client::handle_read_status_line, this,
                    asio::placeholders::error));
        } else
        {
    ...
    void handle_read_status_line(const system::error_code& err)
    {
        if (!err)
        {
            ...
            asio::async_read_until(socket_, response_, "\r\n\r\n",
                bind(&client::handle_read_headers, this,
                    asio::placeholders::error));
        } else
        {
